    ...
    return(
        <div className="Container_SignUp">
            <div>
                ...
                <input className="Username_input" type="text" name="username"></input>
                <p className="Email">Email</p>
                <input className="Email_input" type="text" name="email"></input>
                <p className="Password">Password</p>
                <input className="Password_input" type='text' name="password"></input>
            </div>
            <div>
                <p className="Twitch">Twitch</p>
                <input className="Twitch_input" type='text' name='twitch'></input>
                <p className="Youtube">Youtube</p>
                <input className="Youtube_input" type="text"></input>
                <p className="Game">Game currently playing</p>
                <input className='Game_input' type='text'></input>
                <p className="SignUp_Text">Sign Up UwU</p>
                <button className="Button_signUp">Finish</button>
            </div>
        </div>
    );
